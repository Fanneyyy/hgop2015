...
describe('tictactoe game context', function() {
  it('should route command to instantiated tictactoe game with event stream from storage and return and store generated events. ' +
    'Test using fakes/stubs.', function(done) {

    var calledWithEventStoreId;
    var storedEvents;
    var eventStorageStub = {
    ...
    var boundedContext = require('./tictactoeBoundedContext')(eventStorageStub, commandHandlers);
  ...
  //it('should route command to instantiated tictactoe game with event stream from storage and return generated events, ' +
